...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href="table-data-tutor.jsp"><i class='app-menu__icon bx bx-id-card'></i> <span
            class="app-menu__label">Quản lý gia sư</span></a></li>
      ...
      <li><a class="app-menu__item" href="table-data-oder.html"><i class='app-menu__icon bx bx-task'></i><span
            class="app-menu__label">Quản lý lớp</span></a></li>
