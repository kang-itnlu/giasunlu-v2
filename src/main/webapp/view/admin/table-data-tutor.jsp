        ...
        <div class="tile-body">
          ...
          <div class="row element-button">
            <div class="col-sm-2">
              ...
              <a class="btn btn-add btn-sm" href="./form-add-tutor.jsp" title="Thêm"><i class="fas fa-plus"></i>
                Tạo mới gia sư</a>
            </div>
            <div class="col-sm-2">
          ...
          <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
            ...
            <tr>
              ...
              <td class="table-td-center"><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
                ...
                <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" ><a class="btn btn-primary btn-sm edit" width="20px" href="./form-add-tutor.jsp" ><i class="fas fa-edit" ></i> </a>
                </button>
            ...
            <tr>
              ...
              <td>Tư vấn</td>
              <td>
                <button class="btn btn-primary btn-sm trash" type="button" title="Xóa" onclick="myFunction()"><i
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="form-group  col-md-6">
            <label for="exampleSelect1" class="control-label">Trình độ</label>
...
=======
<head>
  <title>Danh sách gia sư | Quản trị Admin</title>
  <meta charset="utf-8">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href="index.jsp"><i class='app-menu__icon bx bx-tachometer'></i><span
            class="app-menu__label">Doanh số</span></a></li>
      <li><a class="app-menu__item active" href="./table-data-tutor.jsp"><i class='app-menu__icon bx bx-id-card'></i>
      ...
      <li><a class="app-menu__item" href="../index.html"><i class='app-menu__icon bx bx-cog'></i><span class="app-menu__label">Đăng xuất</span></a></li>
    </ul>
  </aside>
  <main class="app-content">
    <div class="app-title">
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>0931491997</td>
                  <td>Thu ngân</td>
                  <td><button class="btn btn-primary btn-sm trash" type="button" title="Xóa" onclick="myFunction()"><i class="fa-duotone fa-lock-keyhole"></i>
                    </button>
                    <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"
                      data-toggle="modal" data-target="#ModalUP"><i class="fas fa-edit"></i>
                    </button>
