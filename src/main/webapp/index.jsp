...
<head>
    ...
    <link href="view/client/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" style="min-height: 300px;">
                <img class="position-relative w-100" src="view/client/img/carousel-1.jpg" style="min-height: 300px; object-fit: cover;">
            ...
            <div class="carousel-item" style="min-height: 300px;">
                <img class="position-relative w-100" src="view/client/img/carousel-2.jpg" style="min-height: 300px; object-fit: cover;">
                <div class="carousel-caption d-flex align-items-center justify-content-center">
                    <div class="p-5" style="width: 100%; max-width: 900px;">
                        <h5 class="text-white text-uppercase mb-md-3">Trung tâm gia sư GiaSuNLU</h5>
                        <h1 class="display-3 text-white mb-md-4">Mang thành công đến với con bạn</h1>
            ...
            <div class="carousel-item" style="min-height: 300px;">
                <img class="position-relative w-100" src="view/client/img/carousel-3.jpg" style="min-height: 300px; object-fit: cover;">
                <div class="carousel-caption d-flex align-items-center justify-content-center">
                    <div class="p-5" style="width: 100%; max-width: 900px;">
                        <h5 class="text-white text-uppercase mb-md-3">Trung tâm gia sư GiaSuNLU</h5>
                        <h1 class="display-3 text-white mb-md-4">Mang thành công đến với con bạn</h1>
...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-5">
                <img class="img-fluid rounded mb-4 mb-lg-0" src="view/client/img/about.jpg" alt="">
            </div>
            <div class="col-lg-7">
    ...
    <div class="container pt-5 pb-3">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 text-center team mb-4">
                <div class="team-item rounded overflow-hidden mb-2">
                    <div class="team-img position-relative">
                        <img class="img-fluid" src="view/client/img/team-1.jpg" alt="">
            ...
            <div class="col-md-6 col-lg-3 text-center team mb-4">
                <div class="team-item rounded overflow-hidden mb-2">
                    <div class="team-img position-relative">
                        <img class="img-fluid" src="view/client/img/team-2.jpg" alt="">
                        <div class="team-social">
                            <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-linkedin-in"></i></a>
            ...
            <div class="col-md-6 col-lg-3 text-center team mb-4">
                <div class="team-item rounded overflow-hidden mb-2">
                    <div class="team-img position-relative">
                        <img class="img-fluid" src="view/client/img/team-3.jpg" alt="">
                        <div class="team-social">
                            <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-linkedin-in"></i></a>
            ...
            <div class="col-md-6 col-lg-3 text-center team mb-4">
                <div class="team-item rounded overflow-hidden mb-2">
                    <div class="team-img position-relative">
                        <img class="img-fluid" src="view/client/img/team-4.jpg" alt="">
                        <div class="team-social">
                            <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-light btn-square mx-1" href="#"><i class="fab fa-linkedin-in"></i></a>
        ...
        <div class="row graphic_block-list-3">
            <div class="col-lg-4 col-md-6 mb-4 graphic_block">
                <div class="graphic_block-img">
                    <img class="img-fluid" src="view/client/img/phuong-phap-day-hieu-qua.svg" alt="">
                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4 graphic_block">
                <div class="graphic_block-img">
                    <img class="img-fluid" src="view/client/img/cam-ket-tien-bo.svg" alt="">
                </div>
                <div class="graphic_block-body">
                    <h4>Tiến bộ nhanh</h4>
            ...
            <div class="col-lg-4 col-md-6 mb-4 graphic_block">
                <div class="graphic_block-img">
                    <img class="img-fluid" src="view/client/img/hoc-thu-2-buoi.svg" alt="">
                </div>
                <div class="graphic_block-body">
        ...
        <div class="row pt-3">
            ...
            <div class="col-lg-4">
                ...
                <div style="max-width:200px" class="d-inline-block">
                    <img src="view/client/img/page/tao-dung-tuong-lai-cho-con.png" alt="Tạo dựng tương lai cho con">
                </div>
...
<script src="view/client/lib/easing/easing.min.js"></script>
<script src="view/client/lib/owlcarousel/owl.carousel.min.js"></script>

<!-- Contact Javascript File -->
<script src="view/client/mail/jqBootstrapValidation.min.js"></script>
<script src="view/client/mail/contact.js"></script>
